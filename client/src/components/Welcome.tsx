...
const Input = ({ placeholder, name, type, value, handleChange } : InputProps) => (
  <input
    ...
    className="my-2 w-full  pl-4 py-2 outline-none bg-transparent text-white border-none text-sm white-glassmorphism"
  />
);
  ...
  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start items-start flex-col md:mr-12">
